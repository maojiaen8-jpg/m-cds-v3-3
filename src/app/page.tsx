  ...
  return (
    <div className="mcds-app">
      <style>{`
        ...
        .input-dark { background: #000; border: 1px solid #333; color: #fff; padding: 12px; border-radius: 12px; margin-bottom: 10px; outline: none; box-sizing: border-box; }
                ...
                <tr key={a.id}>
                  ...
                  <td>
                    <select className="sel-dark" defaultValue={a.phv_stage} onChange={e=>updateAthlete(a.id, {phv_stage:e.target.value})}>
                      <option value="pre">发育前期(Pre)</option>
                      <option value="post">发育后期(Post)</option>
                    </select>
                  </td>
                  <td>
                  ...
                  <td style={{textAlign:'right'}}>
                    <Eye size={22} style={{marginRight:20, cursor:'pointer'}} onClick={()=>setActiveAthlete(a)} />
